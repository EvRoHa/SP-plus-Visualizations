...
make_conf_graphs(old=True, week=8, order='sp+')
make_conf_graphs(old=True, week=8, order='winexp')
make_cluster_graphs(old=True, week=8, order='sp+')
make_cluster_graphs(old=True, week=8, order='winexp')
make_team_graphs(old=True, week=8)
