...
make_conf_graphs(old=True, week=7, order='sp+')
make_conf_graphs(old=True, week=7, order='winexp')
make_cluster_graphs(old=True, week=7, order='sp+')
make_cluster_graphs(old=True, week=7, order='winexp')
make_team_graphs(old=True, week=7)
